    ...
    sentMsg
      ...
      .then(async (interaction) => {
        if (interaction.customId === "cancelrulesreminder") {
            ...
            .addFields(
              {
                ...
                value:
                  'Rule 4 covers partisan misinformation *(also partly covered by Rule 11)*, supporting violent extremist groups *(such as ANTIFA and the Proud Boys)* or violent extremist leaders *(such as Hitler, Stalin, Mao)*, suggesting the exclusion of a group from political participation or society *(such as saying Republicans should not be allowed to be in office)*, advocating for the violent overthrow of government, or other posts similar to these criteria which may be deemed "Political Extremism" in an American context.',
                inline: true,
              },
              {
                name: "✅  How can I avoid violating this rule?",
          ...
          .setColor("White")
          .setTitle("1️⃣3️⃣  Rule 13 Reminder")
          .setDescription(
            `Hey there, ${targetUser.toString()}!\n\nOperation Politics is primarily a platform for discussing politics and encouraging people to engage with civic processes and get involved in our political systems, or otherwise learn about them. Thus, we have an obligation to ensure that information regarding participating in our civic processes is factual, reliable, helpful, and encouraging. Providing false or misleading information about voting, our civic processes, or otherwise is against our rules, as well as actively discouraging people from voting or participating in our processes. \n\n[This message](${targetMsg.url}) was potentially in violation of Rule 13 **(or this message was sent just as a general reminder!)** so we encourage you to revisit the rule in <#775838975755681842> and make sure you're not stepping out of boundaries.`
          )
          .addFields(
            {
              name: "❔ Why does this rule even exist?",
              value: 'It exists for two primary purposes: 1. Ensuring people do not use our platform as a means to espouse anti-democratic arguments or misinformation that may discourage people from participating in our civic processes and 2. Because Discords Community Guidelines include ["obstruction of civic processes"](https://discord.com/guidelines#:~:text=obstruction%20of%20participation%20in%20civic%20processes) as part of their misinformation rule.'
            },
            {
              name: "✅  How can I avoid violating this rule?",
              value: "Avoid actively discouraging people to vote. Making arguments as to why the system is ineffective or bad is fine, as long as you are not outright telling people they should not participate for whatever reason. Additionally, do not spread false information about our civic processes, elections, or other political system related topics, or otherwise attempt to directly prevent someone from participating."
            }
          )
          .setFooter({
            text: "This is a rule reminder generated by a Moderator. This is not an official warning. Take it in good faith, don't argue about it in public chats, and open a ticket if you have any questions.",
